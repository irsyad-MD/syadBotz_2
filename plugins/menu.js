exports.run = {
   ...
   async: async (m, {
      ...
      try {
      let captions = ` ❑  *I N F O - B O T*\n\n◦  Sistem otomatis (ofc.syadBotzV2) yang dapat membantu untuk melakukan sesuatu, mencari dan mendapatkan data/informasi hanya melalui WhatsApp.\n\n❑ *N O T E* \n\n◦   Gunakan bot di private message agar bot merespon dengan cepat, \n\n◦  Beri jeda  yah kak ｡⁠◕⁠‿⁠◕⁠｡\nSource code:pc owner\n No Wa BotV1:https://wa.me/6285717667324
 ❑  *U S E R - I N F O*
...
◦ 𝙿𝙴𝙽𝚈𝙴𝙳𝙸𝙰 𝚂𝙲𝚁𝙸𝙿𝚃
      client.sendMessageModify(m.chat, captions, m, {
               ...
               largeThumb: true,
               thumbnail: await Func.fetchBuffer('https://telegra.ph/file/48b365c5c96e819eff0b4.jpg'),
               url: ''
            })
      } catch (e) {
